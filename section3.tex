...
%TODO [OK] Caso necessário, indicar apenas o site em algum outro ponto do artigo (remover o parágrafo abaixo).
...
\begin{table}[!htbp]
\centering
\caption{Description of Dependent and Independent Variables.}
\label{tab:variables}
\resizebox{1\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Name of \\ the Variable\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Type of \\ the Variable\end{tabular}} & \textbf{Class} & \textbf{Entity} & \textbf{\begin{tabular}[c]{@{}c@{}}Type of \\ Attribute\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Scale \\ Type\end{tabular}} & \textbf{Range} & \textbf{\begin{tabular}[c]{@{}c@{}}Counting \\ Rule\end{tabular}} \\ \hline
\begin{tabular}[c]{@{}c@{}}Development \\ Methodology\end{tabular} & Independent & Method & \begin{tabular}[c]{@{}c@{}}Software \\ development \\ methodology\end{tabular} & N/A & Nominal & \begin{tabular}[c]{@{}c@{}}SSD and\\ SPL\end{tabular} & N/A \\ \hline
\begin{tabular}[c]{@{}c@{}}Software \\ Products\end{tabular} & Independent & Product & \begin{tabular}[c]{@{}c@{}c@{}}Mobile \\ software \\ product\end{tabular} & N/A & Nominal & P1 and P2 & N/A \\ \hline
\begin{tabular}[c]{@{}c@{}}Time \end{tabular} & Dependent & Product & \begin{tabular}[c]{@{}c@{}}Time to \\ market\end{tabular}  & \begin{tabular}[c]{@{}c@{}}Internal: time; \\ external: time \\ to market.\end{tabular} & Ordinal & \begin{tabular}[c]{@{}c@{}}From\\ 00:00:00 \\ to 03:00:00\end{tabular} & Equation \ref{eq:1} \\ \hline
Faults & Dependent & Product & \begin{tabular}[c]{@{}c@{}c@{}c@{}}Number of \\ faults \\ in each \\ software \\ product\end{tabular} & \begin{tabular}[c]{@{}c@{}}Internal: faults; \\ external: quality.\end{tabular} & Ordinal & \begin{tabular}[c]{@{}c@{}}Any\\ positive \\ integer\end{tabular} & Equation \ref{eq:2} \\ \hline
\end{tabular}%
}
\end{table}

Time-to-market is the time spent, in average, for the implementation of a software product with a specific group of variabilities of \texttt{M-SPLear\allowbreak ning}. With regard to the number of faults, the implemented products were tested using the concept of test cases \cite{craig02}. Thus, it was possible to quantify the mean of defects of products. Such metrics are relevant since they are directly related to time-to-market and quality of the m-learning applications. Additionally, they are relevant metrics for development industry \cite{jabangwe18}.

\subsubsection*{Participants}

In our study, the participants were employees from a Brazilian software development company. All of them were volunteers and had at least one year of software development experience (Java, Microsoft .NET and/or PHP).

%TODO [OK] Reescrever/Esclarecer o paragrafo a seguir.
...
%TODO [OK] A Ellen questionou o termo "Block classification".
...
%TODO [OK] Reorganizar o trecho comentado em uma sessão anterior (Introducão/Background)
...
%TODO [OK] Analisar se o paragrafo a seguir não deveria estar mais próximo às discussões/conclusões do artigo.
...
%TODO [OK] Dar mais corpo para a discussão ou diluí-la na secão anterior.
%TODO Avaliar se ao invés de falar tanto na secão anterior, só esta tabela não seria suficiente?
...
Regarding construction validity, we explore the following item:
